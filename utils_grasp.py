...
def spawn_mug():
	#-Y 1 For Yaw, rotation about z axis
 	os.system("rosrun gazebo_ros spawn_model -file <path_to_cup>/cup.urdf -urdf -model 7 -x .6 -y -.1 -z 0.55 -Y -1.57")
